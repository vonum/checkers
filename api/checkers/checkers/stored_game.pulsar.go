...
var (
	...
	fd_StoredGame_moveCount protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_StoredGame_moveCount = md_StoredGame.Fields().ByName("moveCount")
}
...
func (x *fastReflection_StoredGame) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MoveCount != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MoveCount)
		if !f(fd_StoredGame_moveCount, value) {
			return
		}
	}
}
...
func (x *fastReflection_StoredGame) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "checkers.checkers.StoredGame.deadline":
		return x.Deadline != ""
	case "checkers.checkers.StoredGame.moveCount":
		return x.MoveCount != uint64(0)
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_StoredGame) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "checkers.checkers.StoredGame.moveCount":
		panic(fmt.Errorf("field moveCount of message checkers.checkers.StoredGame is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: checkers.checkers.StoredGame"))
		}
		...
		for iNdEx < l {
			...
			case 8:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MoveCount |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *StoredGame) GetMoveCount() uint64 {
	if x != nil {
		return x.MoveCount
	}
	return 0
...
var file_checkers_checkers_stored_game_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x73, 0x22, 0xc6, 0x01, 0x0a, 0x0a, 0x53, 0x74, 0x6f,
	...
	0x69, 0x6e, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x6d, 0x6f, 0x76, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x6d, 0x6f, 0x76, 0x65, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x42, 0xbe, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65,
	0x72, 0x73, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x72, 0x73, 0x42, 0x0f, 0x53, 0x74, 0x6f,
	0x72, 0x65, 0x64, 0x47, 0x61, 0x6d, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2f,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x76, 0x6f, 0x6e, 0x75, 0x6d,
